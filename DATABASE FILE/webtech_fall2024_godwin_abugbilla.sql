...
--
-- Database: `ecom_history`
--
---CREATE DATABASE ecom_history;
---USE ecom_history;
-- --------------------------------------------------------
...
CREATE TABLE `history` (
  ...
  `history_button` varchar(255) NOT NULL,
...
INSERT INTO `history` (`history_id`, `history_title`, `history_image`, `history_desc`, `history_button`, `history_url`) VALUES
(4, 'History of Kente', 'history (3).jpg', '<p style=\"text-align: center;\"><strong>180-182 RECENTS STREET, History of Kente, W1B 5BT</strong></p>\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut libero erat, aliquet eget mauris ut, dictum sagittis libero. Nam at dui dapibus, semper dolor ac, malesuada mi. Duis quis lobortis arcu. Vivamus sed sodales orci, non varius dolor.</p>', 'View Map', 'http://www.thedailylux.com/ecommerce'),
(5, 'ADWINASA  history', 'history (1).png', '<p style=\"text-align: center;\"><strong>109 COLUMBUS CIRCLE, ADWINASA , NY10023</strong></p>\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut libero erat, aliquet eget mauris ut, dictum sagittis libero. Nam at dui dapibus, semper dolor ac, malesuada mi. Duis quis lobortis arcu. Vivamus sed sodales orci, non varius dolor.</p>', 'View Map', 'http://www.thedailylux.com/ecommerce'),
(6, 'OBAAKOFO MMU MAN history', 'history (2).jpg', '<p style=\"text-align: center;\"><strong>2133 RUE SAINT-BAAKOFO MMU MAN, 75001 PARIS&nbsp;</strong></p>\r\n<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut libero erat, aliquet eget mauris ut, dictum sagittis libero. Nam at dui dapibus, semper dolor ac, malesuada mi. Duis quis lobortis arcu. Vivamus sed sodales orci, non varius dolor.</p>', 'View Map', 'http://www.thedailylux.com/ecommerce');
...
--
ALTER TABLE `history`
  MODIFY `history_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
