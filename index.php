...
<main>
    <div class="nero">
        <a href="shop.php" class="btn1" style="color: red;">View all products</a>
    </div>
    <!-- Main -->
    <div class="wrapper">
  ...
  <div class="container clearfix">
    ...
    <div class="footer-nav__col footer-nav__col--info">
      ...
      <ul class="footer-nav__list">
        ...
        <li class="footer-nav__item">
          <a href="#" class="footer-nav__link">Kente Knowledge</a>
        </li> -->
        <li class="footer-nav__item">
    ...
    <div class="footer-nav__col footer-nav__col--contacts">
      ...
      Head Office: KenteFashion.<br>
     Upper East Region, Ghana.
    </address>
      <div class="phone">
        Telephone:
        <a class="phone__number" href="tel:0123456789">+233591061175</a>
      </div>
      <div class="email">
        Email:
        <a href="mailto:support@yourwebsite.com" class="email__addr">abugbilla2025@gmail.com</a>
      </div>
    </div>
...
<div class="page-footer__subline">
  <div class="container clearfix">
    ...
    <div class="copyright">
      &copy; <?php echo date("Y");?> Ecommerce&trade;
    </div>
