...
if($pro_label == ""){
  ...
  ";
    ...
    $p_cat_title = isset($row_p_cat['p_cat_title']) ? $row_p_cat['p_cat_title'] : 'Default Category'; 
?>
...
// Add a null check before accessing array
if ($row_manufacturer = mysqli_fetch_array($run_manufacturer)) {
    $manufacturer_name = $row_manufacturer['manufacturer_title'];
} else {
    $manufacturer_name = "Unknown Manufacturer"; // Provide a default value
}
