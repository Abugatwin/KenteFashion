  ...
  <div class="container"><!-- container Starts -->
    ...
    <div class="col-md-3"><!-- col-md-3 Starts -->
      <div class="box"><!-- box Starts -->
        ...
        <?php
        // Fetch the first term from the database
        $get_terms = "select * from terms LIMIT 0,1";
        $run_terms = mysqli_query($con, $get_terms);

        // Loop through the fetched term
        ...
        // Fetch remaining terms after the first one
    ...
    <div class="col-md-9"><!-- col-md-9 Starts -->
      <div class="box"><!-- box Starts -->
        ...
        <?php
        // Fetch the first term description and title for display
        $get_terms = "select * from terms LIMIT 0,1";
        $run_terms = mysqli_query($con, $get_terms);
        ...
        <?php
        // Fetch remaining terms
        $count_terms = "select * from terms";
        $run_count = mysqli_query($con, $count_terms);
        $count = mysqli_num_rows($run_count);

        // Fetch remaining terms for display
        $get_terms = "select * from terms LIMIT 1,$count";
        $run_terms = mysqli_query($con, $get_terms);
